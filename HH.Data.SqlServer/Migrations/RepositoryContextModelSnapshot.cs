...
namespace HH.Data.SqlServer
{
    ...
    partial class RepositoryContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Summary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Vacancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Summary", b =>
                {
                    b.HasOne("HH.Api.Entities.Models.Employee", "Employee")
                        .WithMany("Summaries")
            ...
            modelBuilder.Entity("HH.Api.Entities.Models.Vacancy", b =>
                {
                    b.HasOne("HH.Api.Entities.Models.Company", "Company")
                        .WithMany("Vacancies")
